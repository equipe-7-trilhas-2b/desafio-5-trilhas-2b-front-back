          ...
          <main className="content">
            ...
            <section className="contatos">
              ...
              <div className="icones-contato">
                <a href="tel:193" title="Ligar para os Bombeiros" className="contato-item">
                  <img src="/bombeiros.png" alt="Bombeiros" />
                  <span>Bombeiros</span>
                </a>

                <a href="tel:190" title="Ligar para a Polícia Militar" className="contato-item">
                  <img src="/pm.png" alt="Polícia Militar" />
                  <span>Polícia Militar</span>
                </a>

                <a href="tel:192" title="Ligar para o SAMU" className="contato-item">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  title="Acessar site da Defesa Civil"
